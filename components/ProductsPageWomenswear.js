...
import heroLadyinBlack from '../images/home-lady-in-black.jpg'


const ProductsPageWomenswear = ({ products }) => {
    return (
        <>
            {/* Page Hero Image */}
...
ProductsPageWomenswear.propTypes = {
    products: PropTypes.any
}
export default ProductsPageWomenswear
    ...
    return (
        <section className="relative py-16 min-w-screen animation-fade animation-delay">
            <div className="container px-8 mx-auto sm:px-12 xl:px-5">
                ...
                <div className="w-full px-6 py-6 mx-auto mt-10 bg-slate-50 sm:px-8 md:px-12 sm:py-8 lg:w-5/6 xl:w-2/3 rounded-lg">
                    <h3 className="text-lg font-bold  sm:text-xl md:text-2xl">INTELLECTUAL PROPERTY RIGHTS</h3>
                    <p className="mt-2 text-base  sm:text-lg md:text-normal">
                ...
                <div className="w-full px-6 py-6 mx-auto mt-10 bg-slate-50 sm:px-8 md:px-12 sm:py-8 lg:w-5/6 xl:w-2/3 rounded-lg">
                    <h3 className="text-lg font-bold  sm:text-xl md:text-2xl">USER REPRESENTATIONS</h3>
                    <p className="mt-2 text-base  sm:text-lg md:text-normal">
                ...
                <div className="w-full px-6 py-6 mx-auto mt-10 bg-slate-50 sm:px-8 md:px-12 sm:py-8 lg:w-5/6 xl:w-2/3 rounded-lg">
                    <h3 className="text-lg font-bold  sm:text-xl md:text-2xl">USER REGISTRATION</h3>
                    <p className="mt-2 text-base  sm:text-lg md:text-normal">
                ...
                <div className="w-full px-6 py-6 mx-auto mt-10 bg-slate-50 sm:px-8 md:px-12 sm:py-8 lg:w-5/6 xl:w-2/3 rounded-lg">
                    <h3 className="text-lg font-bold  sm:text-xl md:text-2xl">PRODUCTS</h3>
                    <p className="mt-2 text-base  sm:text-lg md:text-normal">
                    ...
                    We reserve the right to discontinue any products at any 
                    time for any reason. Prices for all products are subject 
                    to change.
                   </p>
                </div>
            </div>

    ...
    return (
        <>
            ...
            <section class="relative py-16 min-w-screen animation-fade animation-delay">
                <div class="container px-8 mx-auto sm:px-12 xl:px-5 lg:pb-20">
                    <h3 class="mt-1 text-2xl font-bold text-left  sm:mx-0 sm:text-3xl md:text-4xl lg:text-5xl sm:text-left">
                        Our Story
                    </h3>
                    <div class="w-full px-6 py-6 mx-auto mt-10 sm:px-8 md:px-12 sm:py-8 lg:w-5/6 xl:w-2/3 rounded-lg bg-slate-50">
